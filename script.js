function calcularImc(){
    ...
    if(isNaN(peso) || isNaN(altura)){
        ...
        var resultado = Math.floor(peso / (altura*altura));
        console.log(resultado);

        if(resultado >= 0 && resultado < 19){
            aviso.innerHTML = "Você está abaixo do peso: " + resultado;
            aviso.className = "aviso-abaixo";
        }else if(resultado >=19 && resultado <=24){
            aviso.innerHTML = "Você está no Peso Ideal: " + resultado;
            aviso.className = "aviso-ideal";
        }else if(resultado >=25 && resultado <=29){
            aviso.innerHTML = "Você está com Sobrepeso: " +  resultado;
            aviso.className = "aviso-sobrepeso";
        }else if(resultado >=30 && resultado <=34){
            aviso.innerHTML = "Você está em Obesidade Grau I: " +  resultado;
            aviso.className = "aviso-obs1";
        }else if(resultado >=35 && resultado <=39){
            aviso.innerHTML = "Você está em Obesidade Grau II: " + resultado;
            aviso.className = "aviso-obs2";
        }else if(resultado >=40){
            aviso.innerHTML = "Você está em Obesidade Grau III: " +  resultado;
